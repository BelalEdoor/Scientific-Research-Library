...
const contact = () => {
  return (
<div className="isolate bg-gradient-to-br from-cyan-100 to-white min-h-screen  px-6 py-24 sm:py-32 lg:px-8">
  ...
  <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      ...
      <div className="sm:col-span-2">
        <label for="company" className="block text-sm/6 font-semibold text-gray-900">Company</label>
        <div className="mt-2.5">
